...
namespace JWOAGameSystem
{
    public class PlayerAttackSkills_03_State : PlayerAttackSkillsState
    {
        ...
        public override void Enter()
        {
            ...
            stateMachine.Player.effectManager.SpawnEffect("Skill3", stateMachine.Player.effectManager.effects[7].prefab.transform.position, stateMachine.Player.effectManager.effects[1].prefab.transform.rotation);
