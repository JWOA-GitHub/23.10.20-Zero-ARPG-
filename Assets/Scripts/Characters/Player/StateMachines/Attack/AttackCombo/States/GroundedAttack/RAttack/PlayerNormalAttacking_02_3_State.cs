...
namespace JWOAGameSystem
{
    public class PlayerNormalAttacking_02_3_State : PlayerAttackComboState
    {
        ...
        public override void Enter()
        {
            ...
            stateName = stateMachine.Player.AnimationData.NormalAttack_AnimationData.NormalAttack_02_3_StateName;
        ...
        protected override void OnLAttackComboStarted(InputAction.CallbackContext context)
        {
            ...
            if (stateMachine.Player.AnimationData.animatorStateInfo.IsName(stateName) && stateMachine.Player.AnimationData.animatorStateInfo.normalizedTime >= 0.4f)
            {
        ...
        protected override void OnRAttackComboStarted(InputAction.CallbackContext context)
        {
            ...
            if (stateMachine.Player.AnimationData.animatorStateInfo.IsName(stateName) && stateMachine.Player.AnimationData.animatorStateInfo.normalizedTime >= 0.5f)
            {
